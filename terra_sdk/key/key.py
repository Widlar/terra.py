...
class Key:
    ...
    def __init__(self, public_key: Optional[PublicKey] = None, hrp: str = "terra"):
    ...
    def acc_address(self) -> AccAddress:
        ...
        return AccAddress(get_bech(self.hrp, self.raw_address.hex()))
    ...
    def val_address(self) -> ValAddress:
        ...
        return ValAddress(get_bech(self.hrp+"valoper", self.raw_address.hex()))
    ...
    def acc_pubkey(self) -> AccPubKey:
        ...
        return AccPubKey(get_bech(self.hrp+"pub", self.raw_pubkey.hex()))
    ...
    def val_pubkey(self) -> ValPubKey:
        ...
        return ValPubKey(get_bech(self.hrp+"valoperpub", self.raw_pubkey.hex()))
